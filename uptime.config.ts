...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: 'immich',
      method: 'HEAD',
      target: 'https://immich.pingfengdieying.site/',
      statusPageLink: 'https://immich.pingfengdieying.site/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'main',
      method: 'HEAD',
      target: 'https://pingfengdieying.site/',
      statusPageLink: 'https://pingfengdieying.site/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'dify',
      method: 'HEAD',
      target: 'https://dify.pingfengdieying.site/',
      statusPageLink: 'https://dify.pingfengdieying.site/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'OpenList',
      method: 'GET',
      target: 'https://alist.pingfengdieying.site/',
      statusPageLink: 'https://alist.pingfengdieying.site/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    }
